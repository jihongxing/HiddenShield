...
const faqs = [
  ...
  {
    q: "“载荷认证标签匹配”“编号签发”和“完整性匹配”代表什么？",
    a: "载荷认证标签匹配只表示水印 payload 符合当前 HiddenShield 编解码认证规则；编号签发表示生成或分配 Watermark ID；Manifest 完整性匹配只表示报告包文件摘要一致。它们都不等于发行方数字签名、实名认证、法定权属确认或司法采信。",
  },
  {
    q: "遇到问题怎么反馈？",
